...
//                System.out.println(result + "-----");
                ...
                if (type == Protocol.TYPE_REGISTER) {
                    ...
                    // 存图
                    File file=new File("../data/image/"+user.getUsername());
...
//将时间拼接在文件名上即可
                    File file1=new File("../data/image/"+user.getUsername()+"/"+time+".png");
                    ...
                    BufferedWriter writer = new BufferedWriter(new FileWriter("../data/AlertList.txt", true));
