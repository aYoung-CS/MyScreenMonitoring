...
public class Server {
	...
	public static void init() throws IOException, KeyStoreException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {
		try {
			...
			ks.load(new FileInputStream("../data/key/server.keystore"), SERVER_KEY_STORE_PASSWORD.toCharArray());
			tks.load(new FileInputStream("../data/key/tserver.keystore"), SERVER_TRUST_KEY_STORE_PASSWORD.toCharArray());
